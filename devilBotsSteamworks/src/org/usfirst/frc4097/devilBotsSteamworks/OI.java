...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("followTarget", new followTarget());
        SmartDashboard.putData("controlGear", new controlGear());
        SmartDashboard.putData("controlShooter", new controlShooter());
