...
public class RobotMap {
    ...
    public static AnalogInput shootershooterPot;
    public static SpeedController shootershooterAccuator;
    public static PIDController shootershooterPID;
    ...
    public static void init() {
        ...
        shootershooterPot = new AnalogInput(0);
        LiveWindow.addSensor("shooter", "shooterPot", shootershooterPot);
        
        shootershooterAccuator = new VictorSP(5);
        LiveWindow.addActuator("shooter", "shooterAccuator", (VictorSP) shootershooterAccuator);
        
        shootershooterPID = new PIDController(1.0, 0.0, 0.0, 0.0, shootershooterPot, shootershooterAccuator, 0.02);
        LiveWindow.addActuator("shooter", "shooterPID", shootershooterPID);
        shootershooterPID.setContinuous(true);
        shootershooterPID.setAbsoluteTolerance(0.2);
