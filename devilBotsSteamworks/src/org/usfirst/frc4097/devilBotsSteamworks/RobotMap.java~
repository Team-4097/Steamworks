...
public class RobotMap {
    ...
    public static SpeedController shooterSpeedAccuator;
    ...
    public static void init() {
        ...
        shooterSpeedAccuator = new VictorSP(5);
        LiveWindow.addActuator("shooter", "Speed Accuator", (VictorSP) shooterSpeedAccuator);
