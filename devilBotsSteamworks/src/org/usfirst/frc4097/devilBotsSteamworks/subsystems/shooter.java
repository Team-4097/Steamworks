...
public class shooter extends Subsystem {
    ...
    private final AnalogInput shooterPot = RobotMap.shootershooterPot;
    private final SpeedController shooterAccuator = RobotMap.shootershooterAccuator;
    private final PIDController shooterPID = RobotMap.shootershooterPID;
    ...
    public void takeJoytickInput(Joystick main){
    	...
    	if(main.getRawButton(5)){
    		shooterAccuator.set(-1.0);
    	}
    	else{
    		shooterAccuator.stopMotor();
    	}
